<?php
	...
	class MyApplicationClass extends Application{
		...
		public function __construct(array $values = array()){
			...
			$this["prefix-production.host"]="://www.productionvm.com/myapp/";
			...
			$this["twig"] = $this->extend("twig", function($twig, $app){
				$twig->addFunction(new \Twig_SimpleFunction("asset", function($asset) use($app){
					if($this["asset.url"])
						return $app["host"]."assets".$app["request_stack"]->getMessageRequest()->getBasePath()."/".ltrim($asset, "/");
					else
						return "assets".$app["request_stack"]->getMessageRequest()->getBasePath()."/".ltrim($asset, "/");
 				}));
				return $twig;
			}); 
		}
